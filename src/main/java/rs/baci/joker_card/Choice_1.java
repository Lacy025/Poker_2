...
public class Choice_1 implements MainFrame, Numbers, Winnings, KeyListener {
    ...
    Clip deal_2_Sound;
    int st;
    static final JLabel hold1 = new JLabel(" HOLD");
    static final JLabel hold2 = new JLabel(" HOLD");
    static final JLabel hold3 = new JLabel(" HOLD");
    static final JLabel hold4 = new JLabel(" HOLD");
    static final JLabel hold5 = new JLabel(" HOLD");
    public final Component Middle_1 = new JLabel("                  PRESS HOLD CARDS");
    public final Component Middle_2 = new JLabel("                  PRESS CLEAR CARDS");
    public final Component Middle_3 = new JLabel("                  PRESS DEAL CARDS");
