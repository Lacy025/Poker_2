...
public class Choice_2 implements Numbers, Winnings, MainFrame, KeyListener {
    Clip win_Sound;
    final JLabel doubling = new JLabel("             DOUBLING");
    final JLabel cashing = new JLabel("               CASHING");
    public static final JLabel you_win = new JLabel("             YOU WIN !");
    public static int choice;
    int win;
    Choice_2() throws InterruptedException {
