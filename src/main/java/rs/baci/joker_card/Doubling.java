...
public class Doubling implements MainFrame, KeyListener, Winnings, Numbers {
    final JLabel high = new JLabel("8, 9, 10, J, Q, K = HOCH");
    final JLabel low = new JLabel(" A, 2, 3, 4, 5, 6 = TIEF");
    public static final JLabel High = new JLabel("HOCH");
    public static final JLabel Low = new JLabel("TIEF");
    ...
    static final ImageIcon blank = new ImageIcon(Objects.requireNonNull(loadImage()));
    public static final JLabel Blank = new JLabel(blank);
